...
export default function Hero() {
  ...
  return (
    <section id="hero-content" className="relative min-h-screen flex items-center overflow-hidden container mx-auto px-6">
      ...
      <div className="flex flex-col md:flex-row items-center w-full gap-6">
        ...
        <div className="w-full md:w-1/2 h-[50vh] md:h-[80vh] relative z-0">
